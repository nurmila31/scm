							...
							<div class="panel panel-primary">
								<div class="panel-heading">
									...
									<a class="btn btn-danger pull-right" 
										...
										style="margin-top:-0.5pc;" href="fungsi/hapus/hapus.php?pembelian=beli">
								...
								<div class="panel-body">
										...
										<table class="table table-bordered" id="example1">
											<thead>
												<tr>
													...
													<td> Satuan Barang</td>
													<td style="width:20%;"> Total Beli</td>
													<td> Supplier</td>
													<td> Aksi</td>
												</tr>
											</thead>
											<tbody>
												...
												<form method="POST" action="fungsi/edit/edit.php?beli=beli">
													...
													<td><?php echo $isi['nm_supplier'];?></td>
													<td>
									...
									<br/>
									<?php $hasil = $lihat -> jumlahbeli(); ?>
									<div id="kasirnya">
										<table class="table table-stripped">
											<?php
											// proses bayar dan ke nota
											if(!empty($_GET['faktur'] == 'yes')) {
												$total = $_POST['total'];
												$bayar = $_POST['bayar'];
												if(!empty($bayar))
												{
													...
													if($bayar >= $total)
													{
														...
														for($x=0;$x<$jumlah_dipilih;$x++){
															...
															$d = array($id_barang[$x],$id_supplier[$x],$jumlah[$x],$total[$x],$tgl_input[$x],$periode[$x]);
															$sql = "INSERT INTO faktur (id_barang,id_supplier,jumlah,total,tanggal_input,periode) VALUES(?,?,?,?,?,?)";
											...
											?>
											<!-- aksi ke table nota -->
											<form method="POST" action="index.php?page=beli&faktur=yes#kasirnya">
												<?php foreach($hasil_pembelian as $isi){;?>
											...
											<tr>
												...
												<td></td>
												<td>
													<a href="print.php?nm_supplier=<?php echo $_SESSION['admin']['nm_supplier'];?>
...
$(document).ready(function(){
	$("#cari").change(function(){
		$.ajax({
		type: "POST",
		url: "fungsi/edit/edit.php?cari_barang1=yes",
